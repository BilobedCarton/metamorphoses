                ...
                <div className="Credits">
                    ...
                    <div className="Credits-Columns  Credits-Text-Medium">
                        ...
                        <div className="Credits-Column">
                            ...
                            <p className="Credits-Column-Row">
                                <b>Erin Solomon</b>
                                <br/>
                                Production Stage Manager &amp; Digital Asset Designer
                            </p>
                        </div>
                    </div>
                    ...
                    <div style={{ textAlign: "left", marginTop: "5vmin", lineHeight: "1.7vmin"}}>
                        ...
                        <div className="Credits-Text-Small" style={{ display: "flex", lineHeight: 1 }}>
                            <div>
                                Production Stage Manager &amp; Digital Asset Designer <br/> <br/>
                                Prop Director <br/> <br/>
                                Production Assistant &amp; Closed Captioning <br/> <br/>
                                Video Editing <br/> <br/> <br/> <br/> <br/>
                    ...
                    <div style={{ marginTop: "8vmin" }}>
                        <p className="Credits-Text-Large" style={{ marginBottom: "0vmin" }}><b>SPECIAL THANKS</b></p>
                        <p className="Credits-Text-Medium" style={{ marginTop: "0vmin" }} >
